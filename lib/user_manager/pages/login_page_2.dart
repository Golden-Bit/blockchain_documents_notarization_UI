import 'package:blockchain_docuemnts_notarization/home.dart';

import 'package:blockchain_docuemnts_notarization/user_manager/pages/confirm_email_page.dart';
...
// Costruisci l'oggetto User impostando fullName uguale a username
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (context) => HomeScaffold(accessToken: token.accessToken),
          ),
        );
      } catch (e) {
        setState(() {
